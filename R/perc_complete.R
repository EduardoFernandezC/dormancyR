...
#' 
#' Sometimes it is important to compute the percentage of data complete in a dataframe to have an idea of the 
...
#' 
#' @details For list of dataframes, it is useful to combine this function with lapply(). The output is a dataframe
