...
For now, `dormancyR` can only handle but not directly download weather data from the chilean databases. Directly downloading is only possible from the [german database](<https://cdc.dwd.de/portal/>) through the function `handle_cdc_germany`. Historic records of temperature extremes can only be downloaded separately as zip files. For this example, download both the [tmin](http://www.cr2.cl/download/cr2_tasmindaily_2018_ghcn-zip/?wpdmdl=15125) and [tmax](http://www.cr2.cl/download/cr2_tasmaxdaily_2018_ghcn-zip/?wpdmdl=15126) zip files and store them into the same folder. These zip files contain information for about 900 weather stations across south america since 1900 to 2017.
